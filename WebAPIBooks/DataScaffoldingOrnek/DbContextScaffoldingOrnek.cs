...
//namespace WebAPIBooks.DataScaffoldingOrnek;
...
////"Data Source=(localdb)\MSSQLLocalDB; Database=TechCareer; Integrated Security=True;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir ModelsScaffoldingOrnek -ContextDir DataScaffoldingOrnek -Context DbContextScaffoldingOrnek
////ancak migration ve update database kullanamayiz, cunku code first ile db ve tablo olusturmadik; tam tersine
////veritabanindan databaseyi ve tabloları çektik ve bizim yerimize otomatik olarak olusturdu. update database yaparsak zaten tablolar db'de mevcut oldugu icin hata verecektir.
//public partial class DbContextScaffoldingOrnek : DbContext
//{
//    public DbContextScaffoldingOrnek()
//    {
//    }

//    public DbContextScaffoldingOrnek(DbContextOptions<DbContextScaffoldingOrnek> options)
//        : base(options)
//    {
//    }
